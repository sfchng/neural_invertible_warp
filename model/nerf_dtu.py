...
class Model(base.Model):
    ...
    def log_scalars(self,opt,var,loss,metric=None,step=0,split="train"):
        ...
        if split=="train":
            ...
            if 'depth_gt' in var.keys() and 'depth' in var.keys():
                ...
                if opt.model == "barf_dtu" and hasattr(self.graph.pose_net, 'sim3_est_to_gt_c2w'):
    ...
    def evaluate_full(self,opt,eps=1e-10):
        ...
        for i,batch in enumerate(loader):
            ...
            # torchvision_F.to_pil_image(pred_rgb_map.cpu()[0]).save("{}/rgb_{}.png".format(test_path,i))
...
class Graph(base.Graph):
    ...
    def forward(self,opt,var,mode=None):
        ...
        if opt.nerf.rand_rays and mode in ["train","test-optim"]:
            ...
            ret = self.render(opt,pose_w2c,intr=var.intr,ray_idx=var.ray_idx,mode=mode,depth_range=depth_range) # [B,N,3],[B,N,1]
        else:          
            pose_w2c = self.get_pose(opt,var,mode=mode) #(:,3,4)
